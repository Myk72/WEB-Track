...
const DashBoard = ({ id }: { id: string | string[] }) => {
  const { data, isError, isLoading } = useGetAllProductByIdQuery(id);
  if (isError) {
    ...
    <div className="flex flex-row gap-14">
      <div className="text-[#25324B] pt-4 w-[815px]">
        <div>
          ...
          <p className=" mb-10">{detail.description}</p>
        </div>
      ...
      <div className="w-[293.5px]">
          ...
          <div>
            <div className="flex flex-row mb-4">
              ...
              <div>
                ...
                <p className="font-medium"> {formatDate(detail.datePosted)}</p>
              </div>
            </div>
            ...
            <div className="flex flex-row  mb-4">
              ...
              <div>
                ...
                <p className="font-medium"> {detail.location.join(", ")}</p>
              </div>
            </div>
        ...
        <div>
          ...
          <ul className="flex flex-row">
            {detail.categories?.map((curr: string, index: number) => (
              <li key={index}>
                {index % 2 === 1 && (
        ...
        <div>
          ...
          {detail.requiredSkills?.map((r: string) => (
            <div
              key={r}
